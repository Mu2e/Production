...
echo "=========================================="
echo "Stage 4: Signal Processing"
echo "=========================================="
echo ""

usage() { echo "Usage: $0
  e.g. Stage4__signal.sh --known MDS2a --signal CeMLeadingLog --rate 1e-13 --nexp 3
  usage:
...
echo "  Dataset: mcs.mu2e.${SIGNAL}.${RELEASE}_${DBPURPOSE}_${DBVERSION}.art"
...
echo "  Dataset: nts.mu2e.ensembleMDS3aMix1BBTriggered.${EVENTNTUPLE}.root"
